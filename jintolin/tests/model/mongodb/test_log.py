...
class MongodbLogTestCase(base.TestCase):
    ...
    def test_create(self):
        ...
        logs = list(self.DATABASE['log'].find())
        logs1 = list(self.DATABASE['log'].find({DOC_ID: id2}))
        self.assertEqual(len(logs), 4)
        self.assertEqual(len(logs1), 2)
